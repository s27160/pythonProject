...
from .views import TenderViewSet, PrivateTenderViewSet, TenderNoteViewSet, FollowPublicTenderViewSet
...
router.register(r'tender-follows', FollowPublicTenderViewSet, basename='tender-follow')
